...
<head>
    ...
    <title>Giriş Yap | <?php echo $panel_ayarlar['panel_aciklama'] ?></title>
    <!-- Seo -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="p-5">
                                    ...
                                    <form action="islemler/islemler.php" method="POST">

                                        <div class="form-group">
                                            <input type="mail" name="kul_mail" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="E - Mail Adresiniz">
                                        </div>
                                    ...
                                    <div class="text-center mt-3">
                                        <br>
                                        <p><?php echo $panel_ayarlar['panel_footer_yazi'] ?></p>
                                    </div>
